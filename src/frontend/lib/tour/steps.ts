...
function moreNavHint(view: ViewId): string {
  const inMore = new Set<ViewId>([
    "budgets", "recurring", "vehicles", "categories", "piggies",
    "capitals", "calculator", "insights", "transparency",
  ]);
...
const VIEW_STEPS: Record<ViewId, TourStep[]> = {
  overview: [
    ...
    step("overview-recent", "Recent Transaction", "Up to three of your latest transactions. Tap one to edit, or View More for the full list.", '[data-tour="tour-overview-recent"]'),
    step("overview-piggies", "Piggies", "Your top savings categories at a glance — tap View More for the full Piggies view.", '[data-tour="tour-overview-piggies"]'),
    lastStep("overview-capitals", "Capitals", "Planning something big — a marriage, a trip, a loan? Capitals tracks a total budget, paid progress, what is still unspent from the savings you assigned to it, and a monthly save amount toward your target date." + moreNavHint("capitals"), navTarget("capitals"), "right"),
  ],
  todos: [
  ...
  transactions: [
    step("transactions-nav", "Transactions", "Every expense and income entry for the month, grouped by day — newest first, including by entry time on the same date.", navTarget("transactions"), "right"),
  ...
  budgets: [
    step("budgets-nav", "Budgets", "Set how much you plan to spend in each category for the month." + moreNavHint("budgets"), navTarget("budgets"), "right"),
  ...
  calculator: [
    step("calculator-nav", "Calculator", "Plan budgets from income after custom tax deductions." + moreNavHint("calculator"), navTarget("calculator"), "right"),
  ...
  categories: [
    step("categories-nav", "Categories", "Your expense and income taxonomy — categories and subcategories." + moreNavHint("categories"), navTarget("categories"), "right"),
  ...
  recurring: [
    step("recurring-nav", "Recurring", "Fixed charges that repeat monthly, quarterly, or yearly." + moreNavHint("recurring"), navTarget("recurring"), "right"),
  ...
  piggies: [
    step("piggies-nav", "Piggies", "One glance at every savings category and its lifetime balance." + moreNavHint("piggies"), navTarget("piggies"), "right"),
  ...
  capitals: [
    step("capitals-nav", "Capitals", "Plan for big future expenses — marriage, trips, loans, or anything custom. Set a total budget and a target date to see how much to save each month; assign savings deposits to a plan and paying an item spends them down." + moreNavHint("capitals"), navTarget("capitals"), "right"),
  ...
  vehicles: [
    step("vehicles-nav", "Vehicles", "Track fuel or charging costs per vehicle — cars, EVs, bikes, and vans each get their own history and Fuel Insights." + moreNavHint("vehicles"), navTarget("vehicles"), "right"),
  ...
  insights: [
    step("insights-nav", "Insights", "Longer-range trends, comparisons, and currency views." + moreNavHint("insights"), navTarget("insights"), "right"),
  ...
  transparency: [
    step("transparency-nav", "Transparency", "A read-only map of how Sched Ledger stores your data in MongoDB." + moreNavHint("transparency"), navTarget("transparency"), "right"),
